<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin Page.master" AutoEventWireup="true" CodeFile="ViewLeptopProduct.aspx.cs" Inherits="Admin_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<asp:GridView ID="GridViewLeptop" runat="server" AutoGenerateColumns="False" Width="550px"
            Style="margin-right: 3px" DataKeyNames="pkprodid" 
        onselectedindexchanging="Select" onrowdeleting="Delete">
            <Columns>
                <asp:TemplateField HeaderText="Leptop Product">
                    <EditItemTemplate>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <table width="100%">
