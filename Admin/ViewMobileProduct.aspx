<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin Page.master" AutoEventWireup="true" CodeFile="ViewMobileProduct.aspx.cs" Inherits="Admin_Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<asp:GridView ID="GridViewMobile" runat="server" AutoGenerateColumns="False" Width="550px"
            Style="margin-right: 3px" DataKeyNames="pkprodid" 
        onrowdeleting="Delete" onselectedindexchanging="Select" >
            <Columns>
                <asp:TemplateField HeaderText="Mobile Product">
                    <EditItemTemplate>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <table width="100%">
